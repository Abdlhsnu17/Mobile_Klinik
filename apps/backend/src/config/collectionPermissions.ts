...
const ALL_ROLES: Role[] = ["admin", "dokter", "bidan", "perawat", "teknis", "umum"]
const CLINICAL_STAFF: Role[] = ["admin", "dokter", "bidan", "perawat", "teknis"]

export const collectionPermissions: Record<CollectionName, CollectionPermission> = {
