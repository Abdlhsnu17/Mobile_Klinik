export declare const USER_ROLES: readonly ["admin", "dokter", "bidan", "perawat", "teknis", "umum"];
...
export declare const APPOINTMENT_STATUSES: readonly ["Menunggu", "Dipanggil", "Diperiksa", "Selesai", "Batal"];
...
export type ClinicalDecision = "outpatient-discharge" | "prescription" | "lab-required" | "radiology-required" | "referral" | "observation" | "inpatient-required";
...
export type InformedConsentType = "tindakan-medis" | "tindakan-bedah" | "anestesi" | "rawat-inap" | "transfusi-darah" | "persetujuan-umum";
...
export type PaymentMethod = "tunai" | "transfer-himbara" | "qris" | "asuransi-swasta" | "asuransi-bumn" | "asuransi-syariah" | "bpjs";
...
export type InsuranceClaimStatus = "draft" | "submitted" | "verified" | "approved" | "paid" | "rejected";
...
export type DocumentCategory = "laporan-barang-masuk" | "berita-surat-masuk" | "komunikasi-antar-unit" | "lainnya";
...
export type ExpenseCategory = "gaji" | "sewa" | "utilitas" | "pembelian-obat" | "operasional" | "pemeliharaan" | "lainnya";
